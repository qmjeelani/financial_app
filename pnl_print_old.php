                                        ...
                                        <div class="portlet-body">
                                            <form class="form-horizontal" id="pnl_room" name="pnl_room" >
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <span for="department_profit" class="input-group-addon">Department Profit</span>
                                                    <input type="text" id="department_profit" name="department_profit" class="form-control" readonly>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                    ...
                                    <div id="fnbdep" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label for="total_sales_fnb" class="col-sm-6 control-label">Total Sales</label>
                                                    <div class="col-sm-4">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="other_income_fnb_calc" name="other_income_fnb_calc" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb[3]->attribute == 'Other Expenses') ? $head_att_fnb[3]->value : ''); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input type="text" class="form-control" id="total_cost_fnb" name="total_cost_fnb" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb[5]->attribute == 'Other Expenses') ? $head_att_fnb[5]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="input-group">
                                                    <span class="input-group-addon">Department Profit</span>
                                                    <input type="text" class="form-control" id="dep_profit_fnb" name="dep_profit_fnb" readonly>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label"></label>
                                    ...
                                    <div id="expenses_group" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                            <form class="form-horizontal" id="expenses_group" name="expenses_group">
                                                ...
                                                <div class="form-group">
                                                    <label for="hotel_admin_general_calc" class="col-sm-6 control-label">Hotel Admin & General <br><small>(Calculated)</small></label>
                                                    <div class="col-sm-4">
