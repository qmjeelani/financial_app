                                            ...
                                            <form class="form-horizontal" id="pnl_room" name="pnl_room" >
                                                ...
                                                <div class="form-group">
                                                    <label for="rooms_occupied" class="col-sm-6 control-label">Room Occupied</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="rooms_occupied" name="rooms_occupied" placeholder="Room Occupied" value="<?php  echo (!empty($current_kpi->rooms_occupied) ? $current_kpi->rooms_occupied : 'Rooms Occupied'); ?>">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="rooms_occupied_2009" name="rooms_occupied_2009" placeholder="Room Occupied" value="<?php  echo (!empty($kpi_2009->rooms_occupied) ? $kpi_2009->rooms_occupied : 'Rooms Occupied'); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="average_room_rate" class="col-sm-6 control-label">Average Room Rate</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="average_room_rate" name="average_room_rate" placeholder="Average Room Rate" value="<?php  echo (!empty($current_kpi->average_room_rate) ? $current_kpi->average_room_rate : ''); ?>">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="average_room_rate_2009" name="average_room_rate_2009" placeholder="Average Room Rate" value="<?php  echo (!empty($kpi_2009->average_room_rate) ? $kpi_2009->average_room_rate : ''); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="payroll_expense_calc_2009" name="payroll_expense_calc_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_expenses_2009" name="other_expenses_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_2009[1]->attribute == 'Other Expenses') ? $head_att_2009[1]->value : ''); ?>">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_expenses_calc_2009" name="other_expenses_calc_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="total_expense_2009" name="total_expense_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3"><input type="text" id="department_profit_2009" name="department_profit_2009" class="form-control" readonly></div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="col-sm-3"><input type="text" id="department_profit_precentage_2009" name="department_profit_precentage_2009" class="form-control" readonly></div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <form class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    <label for="total_cover" class="col-sm-6 control-label">Total Covers (Food)</label>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="total_cover" name="total_cover" placeholder="Total Covers (Food)" value="<?php  echo (!empty($current_kpi->total_covers_food) ? $current_kpi->total_covers_food : 'Total Covers (Food)'); ?>">
                                                        </div>
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="total_cover_2009" name="total_cover_2009" placeholder="Total Covers (Food)" value="<?php  echo (!empty($kpi_2009->total_covers_food) ? $kpi_2009->total_covers_food : 'Total Covers (Food)'); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="food_sales_2009" name="food_sales_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="food_sales_percent_2009" name="food_sales_percent_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="beverage_sales_2009" name="beverage_sales_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="beverage_sales_percent_2009" name="beverage_sales_percent_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3"> 
                                                        <input type="text" class="form-control" id="fnb_other_income_2009" name="fnb_other_income_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[0]->attribute == 'Other Income') ? $head_att_fnb_2009[0]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3"> 
                                                        <input type="text" class="form-control" id="fnb_other_income_percent_2009" name="fnb_other_income_percent_2009" placeholder="Placeholder Text" readonly >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="total_sales_fnb_2009" name="total_sales_fnb_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="food_cost_percent_2009" name="food_cost_percent_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[1]->attribute == 'Food Cost') ? $head_att_fnb_2009[1]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="food_cost_calc_2009" name="food_cost_calc_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="beverage_cost_percent_2009" name="beverage_cost_percent_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[2]->attribute == 'Beverage Cost') ? $head_att_fnb_2009[2]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="beverage_cost_calc_2009" name="beverage_cost_calc_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_income_fnb_2009" name="other_income_fnb_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[3]->attribute == 'Other Expenses') ? $head_att_fnb_2009[3]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_income_fnb_calc_2009" name="other_income_fnb_calc_2009" placeholder="Placeholder Text"  readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="total_cost_sales_fnb_2009" name="total_cost_sales_fnb_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[3]->attribute == 'Other Expenses') ? $head_att_fnb_2009[3]->value : ''); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="total_cost_sales_fnb_percent_2009" name="total_cost_sales_fnb_percent_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[3]->attribute == 'Other Expenses') ? $head_att_fnb_2009[3]->value : ''); ?>" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="payroll_expense_fnb_2009" name="payroll_expense_fnb_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[4]->attribute == 'Payroll & Related Expenses') ? $head_att_fnb_2009[4]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="payroll_expense_fnb_calc_2009" name="payroll_expense_fnb_calc_2009" placeholder="Placeholder Text"  readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="other_expenses_fnb" class="col-sm-6 control-label">Other Expenses</label>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_expenses_fnb" name="payroll_expense_fnb" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb[5]->attribute == 'Other Expenses') ? $head_att_fnb[5]->value : ''); ?>" >
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_expenses_fnb_2009" name="payroll_expense_fnb_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[5]->attribute == 'Other Expenses') ? $head_att_fnb_2009[5]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="other_expenses_fnb_calc_2009" name="other_expenses_fnb_calc_2009" placeholder="Placeholder Text" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="total_cost_fnb_2009" name="total_cost_fnb_2009" placeholder="Placeholder Text" value="<?php  echo (($head_att_fnb_2009[5]->attribute == 'Other Expenses') ? $head_att_fnb_2009[5]->value : ''); ?>" readonly="">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="input-group">
                                                    ...
                                                    <div class="col-sm-3"><input type="text" class="form-control" id="dep_profit_fnb" name="dep_profit_fnb" readonly></div>
                                                        <div class="col-sm-3"><input type="text" class="form-control" id="dep_profit_fnb_2009" name="dep_profit_fnb_2009" readonly></div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <div class="col-sm-3"><input type="text" class="form-control" id="dep_profit_fnb_percent_2009" name="dep_profit_fnb_percent_2009" readonly></div>
                                                </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label"></label>
                                            ...
                                            <form class="form-horizontal" id="minor_operating" name="minor_operating" >
                                                <div class="form-group">
                                                    <label for="min_op_sales" class="col-sm-6 control-label">Sales</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sales_2009" name="min_op_sales_2009" placeholder="Sales" value="<?php  echo (($head_att_min_op_2009[0]->attribute == 'Sales') ? $head_att_min_op_2009[0]->value : ''); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_sales_percent" class="col-sm-6 control-label">Sales <small>(%)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sales_percent_2009" name="min_op_sales_percent_2009" placeholder="Sales" readonly="">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_cost_sales_percent" class="col-sm-6 control-label">Cost of sales (%)</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_cost_sales_percent_2009" name="min_op_cost_sales_percent_2009" placeholder="Cost of Sales" value="<?php  echo (($head_att_min_op_2009[1]->attribute == 'Cost of Sales') ? $head_att_min_op_2009[1]->value : ''); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_cost_sales_calc" class="col-sm-6 control-label">Cost of sales <br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_cost_sales_calc_2009" name="min_op_cost_sales_calc_2009" placeholder="Cost of Sales" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_dep_profit" class="col-sm-6 control-label">Department Profit</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_dep_profit_2009" name="min_op_dep_profit_2009" placeholder="Placeholder Text" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_dep_profit_percent" class="col-sm-6 control-label">Department Profit <small>(%)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_dep_profit_percent_2009" name="min_op_dep_profit_percent_2009" placeholder="Placeholder Text" readonly>
                                                        </div>
                                                </div>
                                                <!----------------->
                                                <br>
                                            <h4>Sports & Recreation</h4>
                                                <div class="form-group">
                                                    <label for="min_op_sports_sales" class="col-sm-6 control-label">Sports & Recreation Sales</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sports_sales_2009" name="min_op_sports_sales_2009" placeholder="Sales" value="<?php  echo (($head_att_min_op_2009[2]->attribute == 'Sports & Recreation Sales') ? $head_att_min_op_2009[2]->value : ''); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_sports_sales_percentage" class="col-sm-6 control-label">Sports & Recreation Sales <small>(%)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sports_sales_percentage_2009" name="min_op_sports_sales_percentage_2009" placeholder="Sales" readonly="">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_sports_sales_percent" class="col-sm-6 control-label">Sports & Recreation Expenses (%)</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sports_sales_percent_2009" name="min_op_sports_sales_percent_2009" placeholder="Sports & Recreation Expenses (%)" value="<?php  echo (($head_att_min_op_2009[3]->attribute == 'Sports & Recreation Expenses') ? $head_att_min_op_2009[3]->value : ''); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_sports_sales_calc" class="col-sm-6 control-label">Sports & Recreation Expenses <br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sports_sales_calc_2009" name="min_op_sports_sales_calc_2009" placeholder="Sports & Recreation Expenses (Calculated)" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_sports_sales_dep_profit" class="col-sm-6 control-label">Department Profit</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sports_sales_dep_profit_2009" name="min_op_sports_sales_dep_profit_2009" placeholder="Placeholder Text" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="min_op_sports_sales_dep_profit_percent" class="col-sm-6 control-label">Department Profit <small>(%)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="min_op_sports_sales_dep_profit_percent_2009" name="min_op_sports_sales_dep_profit_percent_2009" placeholder="Placeholder Text" readonly>
                                                        </div>
                                                </div>
                                                <!---------------->
                                                <div class="form-group">
                                            ...
                                            <form class="form-horizontal" id="gross_operating_form" name="gross_operating_form" role="form">
                                                <div class="form-group">
                                                    <label for="rental_other_income" class="col-sm-6 control-label">Rental & Other Income</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="rental_other_income_2009" name="rental_other_income_2009" placeholder="rental_other_income" value="<?php  echo (($head_att_min_op_2009[4]->attribute == 'Rental & Other Income') ? $head_att_min_op_2009[4]->value : ''); ?>">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="rental_other_income_percent" class="col-sm-6 control-label">Rental & Other Income <small>(%)</small> </label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="rental_other_income_percent_2009" name="rental_other_income_percent_2009" placeholder="rental_other_income" readonly="">
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="head_office_income" class="col-sm-6 control-label">Head Office Income</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="head_office_income_2009" name="head_office_income_2009" placeholder="Head Office Income_2009" value="<?php  echo (($head_att_min_op_2009[5]->attribute == 'Head Office Income') ? $head_att_min_op_2009[5]->value : ''); ?>">
                                                        </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <label for="head_office_income_percent" class="col-sm-6 control-label">Head Office Income (%)</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="head_office_income_percent_2009" name="head_office_income_percent_2009" placeholder="Head Office Income" readonly="" >
                                                        </div>
                                                </div>
                                            ...
                                            <form class="form-horizontal" id="total_sales_form" name="total_sales_form" role="form">
                                                <div class="form-group">
                                                    <label for="total_sales_all_dep" class="col-sm-6 control-label">Total Sales <br><small>(Sales of all department)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="total_sales_all_dep_2009" name="total_sales_all_dep_2009" placeholder="rental_other_income" readonly>
                                                        </div>
                                                </div>
                                                <!--<button type="submit" class="btn btn-default">Sign in</button>-->
                                            </form>
                                            ...
                                            <form class="form-horizontal" id="gross_operating_income" name="gross_operating_income" role="form">
                                                <div class="form-group">
                                                    <label for="total_gross_income" class="col-sm-6 control-label">Gross Income <br><small>(Income of all department)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="total_gross_income_2009" name="total_gross_income_2009" placeholder="total_gross_income_2009" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="total_gross_income_percent" class="col-sm-6 control-label">Gross Income <br><small>(%)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="total_gross_income_percent_2009" name="total_gross_income_percent_2009" placeholder="total_gross_income_2009" readonly>
                                                        </div>
                                                </div>
                                                <!--<button type="submit" class="btn btn-default">Sign in</button>-->
                                            </form>
                                        ...
                                        <div class="portlet-body">
                                            <form class="form-horizontal" id="expenses_group" name="expenses_group">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="hotel_admin_general_2009" name="hotel_admin_general_2009" placeholder="Hotel Admin & General" value="<?php  echo (($head_att_expense_2009[0]->attribute == 'Hotel Admin & General') ? $head_att_expense_2009[0]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="hotel_admin_general_calc_2009" name="hotel_admin_general_calc_2009" placeholder="Hotel Admin & General"  readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="local_sales_marketing_2009" name="local_sales_marketing_2009" placeholder="Local Sales & Marketing" value="<?php  echo (($head_att_expense_2009[1]->attribute == 'Local Sales & Marketing') ? $head_att_expense_2009[1]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="local_sales_marketing_calc_2009" name="local_sales_marketing_calc_2009" placeholder="Local Sales & Marketing Calc"  readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="energy_costs_2009" name="energy_costs_2009" placeholder="Energy Costs" value="<?php  echo (($head_att_expense_2009[2]->attribute == 'Energy Costs') ? $head_att_expense_2009[2]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="energy_costs_calc_2009" name="energy_costs_calc_2009" placeholder="Energy Costs"  readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="repair_maintence_2009" name="repair_maintence_2009" placeholder="Repair & Maintenance" value="<?php  echo (($head_att_expense_2009[3]->attribute == 'Repair & Maintenance') ? $head_att_expense_2009[3]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="repair_maintence_calc_2009" name="repair_maintence_calc_2009" placeholder="Repair & Maintenance" readonly>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input type="text" class="form-control" id="real_estate_taxes_2009" name="real_estate_taxes_2009" placeholder="Hotel Admin & General" value="<?php  echo (($head_att_expense_2009[4]->attribute == 'Real Estate Taxes/ Insurance') ? $head_att_expense_2009[4]->value : ''); ?>" >
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                            ...
                                            <form class="form-horizontal" id="EBIDAT" name="EBIDAT" role="form">
                                                <div class="form-group">
                                                    <label for="admin_finance_ho" class="col-sm-6 control-label">Admin & Finance (H.O) </label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="admin_finance_ho_2009" name="admin_finance_ho_2009" placeholder="admin_finance_ho_2009" value="<?php  echo (($head_att_ho_charges_2009[1]->attribute == 'Admin & Finance') ? $head_att_ho_charges_2009[1]->value : ''); ?>" >
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="admin_finance_ho_calc" class="col-sm-6 control-label">Admin & Finance (H.O) <br><small>(Calculated)</small> </label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="admin_finance_ho_calc_2009" name="admin_finance_ho_calc_2009" placeholder="admin_finance_ho" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="marketing_ho" class="col-sm-6 control-label">Marketing (H.O)</label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="marketing_ho_2009" name="marketing_ho_2009" placeholder="marketing_ho_2009" value="<?php  echo (($head_att_ho_charges_2009[2]->attribute == 'Marketing') ? $head_att_ho_charges_2009[2]->value : ''); ?>" >
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="marketing_ho_calc" class="col-sm-6 control-label">Marketing (H.O) <br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="marketing_ho_calc_2009" name="marketing_ho_calc_2009" placeholder="marketing_ho_calc" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="management_fee" class="col-sm-6 control-label">Management (Royalty) Fee </label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="management_fee_2009" name="management_fee_2009" placeholder="management_fee" value="<?php  echo (($head_att_ho_charges_2009[3]->attribute == 'Management Fee') ? $head_att_ho_charges_2009[3]->value : ''); ?>" >
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="management_fee_calc" class="col-sm-6 control-label">Management (Royalty) Fee <br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="management_fee_calc_2009" name="management_fee_calc_2009" placeholder="management_fee_calc" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="head_office_charges" class="col-sm-6 control-label">Head Office Charges <br><small>Admin & Finance + Marketing + Management (Royalty) Fee</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="head_office_charges_2009" name="head_office_charges_2009" placeholder="head_office_charges" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="ebidat_field" class="col-sm-6 control-label">Earning Before Interest Depreciation Amm. & Taxation <br><small>(IBFC - Head Office Charges)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="ebidat_field_2009" name="ebidat_field_2009" placeholder="ebidat_field" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="ebidat_field_percent" class="col-sm-6 control-label">EBIDAT <small>%</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="ebidat_field_percent_2009" name="ebidat_field_percent_2009" placeholder="ebidat_field" readonly>
                                                        </div>
                                                </div>
                                                <!--<button type="submit" class="btn btn-default">Sign in</button>-->
                                            </form>
                                            ...
                                            <form class="form-horizontal" id="income_before_fixed_charges" name="income_before_fixed_charges" role="form">
                                                <div class="form-group">
                                                    <label for="income_bef_fix_charges" class="col-sm-6 control-label">IBFC <br><small>(Income -  All Expenses)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="income_bef_fix_charges_2009" name="income_bef_fix_charges_2009" placeholder="income_bef_fix_charges_2009" readonly>
                                                        </div>
                                                </div>
                                                <!--<button type="submit" class="btn btn-default">Sign in</button>-->
                                            </form>
                                            ...
                                            <form class="form-horizontal" id="pbt" name="pbt" role="form">
                                                <div class="form-group">
                                                    <label for="depreciation_field" class="col-sm-6 control-label">Depreciation<br><small>(From Assumptions)</small></label>
                                                        <div class="col-sm-3 input-group">
                                                            <input type="text" class="form-control" id="depreciation_field" name="depreciation_field" placeholder="depreciation_field" value="<?php  echo (!empty($current_assumptions->depreciation) ? $current_assumptions->depreciation : ''); ?>">
                                                ...
                                                <div class="form-group">
                                                    <label for="depreciation_field_calc" class="col-sm-6 control-label">Depreciation<br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="depreciation_field_calc_2009" name="depreciation_field_calc_2009" placeholder="depreciation_field_calc_2009" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="amortization_field" class="col-sm-6 control-label">Amortization<br><small>(From Assumptions)</small></label>
                                                        <div class="col-sm-3 input-group">
                                                            <input type="text" class="form-control" id="amortization_field" name="amortization_field" placeholder="depreciation_field" value="<?php  echo (!empty($current_assumptions->amortization) ? $current_assumptions->amortization : ''); ?>">
                                                            <span class="input-group-addon">%</span>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="amortization_field_calc" class="col-sm-6 control-label">Amortization<br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="amortization_field_calc_2009" name="amortization_field_calc_2009" placeholder="amortization_field_calc_2009" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pbt_field" class="col-sm-6 control-label">Profit Before Tax <br><small>(EBIDAT - Depreciation - Amortization)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="pbt_field_2009" name="pbt_field_2009" placeholder="income_bef_fix_charges" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pbt_field_percent" class="col-sm-6 control-label">Profit Before Tax <small>%</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="pbt_field_percent_2009" name="pbt_field_percent_2009" placeholder="income_bef_fix_charges" readonly>
                                                        </div>
                                                </div>
                                                <!--<button type="submit" class="btn btn-default">Sign in</button>-->
                                            </form>
                                            ...
                                            <form class="form-horizontal" id="profit_loss" name="profit_loss" role="form">
                                                ...
                                                <div class="form-group">
                                                    <label for="taxation_calc" class="col-sm-6 control-label">Taxation<br><small>(Calculated)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="taxation_calc_2009" name="taxation_calc_2009" placeholder="taxation_calc_2009" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="net_profit_loss" class="col-sm-6 control-label">Net Profit or (Loss) <br><small>(PBT - Taxation)</small></label>
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="net_profit_loss_2009" name="net_profit_loss_2009" placeholder="net_profit_loss_2009" readonly>
                                                        </div>
                                                </div>
                                                <div class="form-group">
                                                    <label for="net_profit_loss_percent" class="col-sm-7 control-label">Net Profit or (Loss) <small>(%)</small></label>
                                                        ...
                                                        <div div class="col-sm-2 input-group-left">
                                                            <input type="text" class="form-control" id="net_profit_loss_percent_2009" name="net_profit_loss_percent_2009" placeholder="net_profit_loss_percent_2009" readonly>
                                                            <span class="input-group-addon">%</span>
                                                        </div>
                                                </div>
                                                <!--<button type="submit" class="btn btn-default">Sign in</button>-->
