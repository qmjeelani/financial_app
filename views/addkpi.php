                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="kpi_year" name="kpi_year" placeholder="Total Number of Rooms"  >
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        <div class="col-sm-4">
                                                        ...
                                                        <div class="col-sm-3">
                                                            <input type="text" class="form-control" id="total_rooms" name="total_rooms" placeholder="Total Number of Rooms"  >
                                                        </div>
...
<!--                                                    <div class="col-sm-6">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="no_of_days" name="no_of_days" placeholder="Number of days" >
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="rooms_vailable" name="rooms_vailable" placeholder="Room Available" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                                <input type="text" class="form-control" id="rooms_occupancy_precent" name="rooms_occupancy_precent" placeholder="Room Occupancy Percentage" >
                                                        </div>
                                                        </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="rooms_occupied" name="rooms_occupied" placeholder="Room Occupied" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="average_room_rate" name="average_room_rate" placeholder="Average Room Rate" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="total_covers_food"  name="total_covers_food" placeholder="Total Covers (Food)" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="average_spend_food" name="average_spend_food" placeholder="Average Spend Food" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="average_spend_beverages" name="average_spend_beverages" placeholder="Average Spend Beverages" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="total_average_spend" name="total_average_spend" placeholder="Total Average Spend"  readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="total_payroll" name="total_payroll" placeholder="Total Payroll" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="total_number_of_employees" name="total_number_of_employees" placeholder="Number of Employees" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-xs-12 col-sm-6 col-lg-12">
                                                        ...
                                                        <div class="col-xs-3">
                                                            <input type="text" class="form-control" id="precentage_revenue" name="precentage_revenue" placeholder="% to Revenue" >
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
