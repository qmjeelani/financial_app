...
$(' #pnl_room #payroll_expense_calc ').val(expense_calc);
...
$(' #pnl_room #other_expenses_calc ').val(other_expenses_calc);
...
$('#beverage_sales').val(beverage_sales);
...
total_sales_fnb = CurrencyFormat(total_sales_fnb);
$('#total_sales_fnb').val(total_sales_fnb);
...
food_cost_calc = CurrencyFormat(food_cost_calc);
$('#food_cost_calc').val(food_cost_calc);
...
beverage_cost_calc = CurrencyFormat(beverage_cost_calc);
$('#beverage_cost_calc').val(beverage_cost_calc);
...
head_office_charges = CurrencyFormat(head_office_charges);
$('#head_office_charges').val(head_office_charges);
...
//ebidat_field = CurrencyFormat(ebidat_field);
...
//depreciation_field_calc = CurrencyFormat(depreciation_field_calc);
...
amortization_field_calc = CurrencyFormat(amortization_field_calc);
$('#amortization_field_calc').val(amortization_field_calc);
...
pbt_field = CurrencyFormat(pbt_field);
$('#pbt_field').val(pbt_field);
...
taxation_calc = CurrencyFormat(taxation_calc);
$('#taxation_calc').val(taxation_calc);
...
$('#net_profit_loss').val(net_profit_loss);
